	...
	class Jet_Smart_Filters_Block_Select extends Jet_Smart_Filters_Block_Base {
		...
		public function add_style_manager_options() {
			...
			$this->controls_manager->add_control([
				...
				'css_selector' => [
					'{{WRAPPER}}.jet-smart-filters-select.jet-filter ' . $this->css_scheme['filter']    => 'max-width: {{VALUE}}{{UNIT}}; flex-basis: {{VALUE}}{{UNIT}}',
					'{{WRAPPER}}.jet-smart-filters-hierarchy.jet-filter ' . $this->css_scheme['select'] => 'max-width: {{VALUE}}{{UNIT}}; flex-basis: {{VALUE}}{{UNIT}}'
				],
				'attributes' => [
					'default' => [
						'value' => [
			...
			$this->controls_manager->add_control([
				...
				'css_selector' => [
					'{{WRAPPER}}.jet-smart-filters-hierarchy.jet-filter .jet-filters-group' => 'display:{{VALUE}};'
				],
				'attributes' => [
					'default' => [
						'value' => 'block'
			...
			$this->controls_manager->add_control([
				...
				'css_selector' => [
					'{{WRAPPER}}.jet-smart-filters-hierarchy.jet-filter .jet-filters-group' => 'gap: {{VALUE}}{{UNIT}};'
				],
				'attributes' => [
					'default' => [
						'value' => [
			...
			$this->controls_manager->add_control([
				...
				'css_selector' => [
					'{{WRAPPER}}.jet-smart-filters-select.jet-filter ' . $this->css_scheme['filter']    => '{{VALUE}}',
					'{{WRAPPER}}.jet-smart-filters-hierarchy.jet-filter ' . $this->css_scheme['select'] => '{{VALUE}}'
				],
				'attributes' => [
					'default' => [
						'value' => 'left'
