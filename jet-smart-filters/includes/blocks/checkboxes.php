		...
		public function set_css_scheme() {
			...
			$this->css_scheme = apply_filters(
				...
				array(
					...
					'disable_button'        => '.jet-filter-row-disable .jet-checkboxes-list__item .jet-checkboxes-list__button',
		...
		public function add_style_manager_options() {
			...
			$this->controls_manager->add_control([
				...
				'css_selector' => [
					...
					'{{WRAPPER}} ' . $this->css_scheme['item'] . ':not(:last-child)'        => 'margin-bottom: {{VALUE}}{{UNIT}};'
				],
				'attributes' => [
					'default' => [
						'value' => 10,
