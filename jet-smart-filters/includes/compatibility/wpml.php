		...
		*/
		...
		$additional_settings_fields_to_add = [
			[
				...
				'type'        => esc_html__( 'Search Placeholder', 'text-domain' ),
				'editor_type' => 'LINE',
			],
			[
				'field'       => 'more_text',
				'type'        => esc_html__( 'More Text', 'text-domain' ),
				'editor_type' => 'LINE',
			],
			[
				'field'       => 'less_text',
				'type'        => esc_html__( 'Less Text', 'text-domain' ),
				'editor_type' => 'LINE',
			],
			[
				'field'       => 'dropdown_placeholder',
				'type'        => esc_html__( 'Placeholder', 'text-domain' ),
				'editor_type' => 'LINE',
			],
			[
				'field'       => 'dropdown_n_selected_text',
				'type'        => esc_html__( 'Generic text', 'text-domain' ),
				'editor_type' => 'LINE',
			],
			[
				'field'       => 'dropdown_apply_button_text',
				'type'        => esc_html__( 'Apply button text', 'text-domain' ),
				'editor_type' => 'LINE',
			]
		];
