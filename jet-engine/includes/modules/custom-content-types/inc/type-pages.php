		...
		if ( ! \Jet_Engine\Modules\Custom_Content_Types\DB::custom_table_exists( $this->factory->get_arg( 'slug' ) ) ) {
			?>
				...
				<div style="margin-top: 20px; padding: 10px;background-color: white;font-size: 1.5em;">
					CCT DB table is missing. Please go to the Content Type <a href="<?php echo $edit_cct_link; ?>">settings page</a> and try to update current Content Type.
				</div>
			<?php
			return;
			...
			?>
				...
				<div style="margin-top: 20px; padding: 10px;background-color: white;font-size: 1.5em;">
					DB column schema is invalid. Please go to the Content Type <a href="<?php echo $edit_cct_link; ?>">settings page</a> and try to update current Content Type.
				</div>
			<?php
			return;
		}
