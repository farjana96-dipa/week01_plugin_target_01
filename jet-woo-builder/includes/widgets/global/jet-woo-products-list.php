...
class Jet_Woo_Products_List extends Jet_Woo_Builder_Base {
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} ' . $css_scheme['inner-box'] . ':hover .jet-woo-products-list__item-img img',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} ' . $css_scheme['price'] => 'display: flex; flex-direction: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} ' . $css_scheme['price'] => 'gap: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'price_sale_display_type' => 'block',
				],
	...
	protected function render() {
		...
		echo $shortcode_obj->do_shortcode( $attributes ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
